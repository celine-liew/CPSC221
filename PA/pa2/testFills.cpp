...
//use for custom
// use for rainbow
#define CUSFREQ 1.0/1000.0
#define CUSTOLERANCE 0.05
#define CUSX 75
#define CUSY 75
#define CUSTESTIMAGE "originals/Canada.png"
#define CUSFRAMEFREQ 500
...
//     PNG img;
//     img.readFromFile(CUSTESTIMAGE);
//     HSLAPixel px(40., 1.0, 0.5);

//     animation anim;
//     anim = filler::fillCustomDFS(img, CUSX, CUSY, CUSFREQ,
//                                          CUSTOLERANCE,
//                                          CUSFRAMEFREQ);
...
//     animation anim;
//     anim = filler::fillCustomBFS(img, CUSX, CUSY, CUSFREQ,
//                                          CUSTOLERANCE,
//                                          CUSFRAMEFREQ);
